...
<html lang="en">
  <head>
    ...
    <meta name="description" content="DES desaccess page">
    ...
    <meta name="application-name" content="DES desaccess">

    <!-- Add to homescreen for Safari on iOS -->
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="default">
    <meta name="apple-mobile-web-app-title" content="DES desaccess">
  ...
  <body>
    <des-main appTitle="desaccess"></des-main>
    <noscript>
